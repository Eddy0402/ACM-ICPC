...
int main(){
	...
	while(testCases--){
		...
		for(int i = 0;i < 92;++i){
			int total = 0;
			for(int row = 0; row < 8; ++row){
				total += board[ row ][ possible[i][row] ];
			}
